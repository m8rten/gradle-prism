...
public class SuperRemoteGradleInvocationResource {

    InvocationRepository invocations

    @POST
    @Consumes("application/json")
    public Response postInvocation(SuperRemoteGradleInvocation remoteGradleInvocation) {
        Invocation invocation = new Invocation()
        invocation.projects = remoteGradleInvocation.projects
        invocation.user = remoteGradleInvocation.user
